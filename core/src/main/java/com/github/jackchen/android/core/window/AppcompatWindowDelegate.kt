...
import com.github.jackchen.android.core.component.ComponentManager.getComponentContainerSet
...
class AppcompatWindowDelegate : WindowDelegate {
  ...
  override fun onCreateView(context: AppCompatActivity,
                            obj: Any,
                            parentView: ViewGroup,
                            view: View,
                            saveInstance: Bundle?): View {
