...
object Libs {
  ...
  const val SAMPLE_API = "com.github.momodae.AndroidSampleLibrary:api:${Versions.SAMPLE}"
  const val SAMPLE_CORE = "com.github.momodae.AndroidSampleLibrary:core:${Versions.SAMPLE}"
