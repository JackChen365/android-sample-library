package com.cz.android.sample.library.appcompat.component.memory;
...
class CurveChartView extends View {
    ...
    private LinkedList<Float> dataArray=new LinkedList<>();
    ...
    public CurveChartView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a=context.obtainStyledAttributes(attrs,R.styleable.SampleCurveChartView,defStyleAttr,R.style.CurveChartViewCompat);
